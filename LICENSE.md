...
> Discord audit log viewer and exporter tool 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

📋 &nbsp;**Full log** — complete Discord audit log in one view

🔍 &nbsp;**Search** — filter by user, action type, or date

📤 &nbsp;**Export** — download audit log as CSV

👤 &nbsp;**User history** — all actions by one member

⏱️ &nbsp;**Real-time** — see new entries as they happen

📊 &nbsp;**Stats** — most common actions and actors
